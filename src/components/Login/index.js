...
import style from './Login.module.scss'; // Import file css/scss
    ...
    return (
        <div className={cx('container')}>
            ...
            <form onSubmit={handleSubmit} className={cx('form')}>
                ...
                <input className={cx('login-button')} type="submit" value="Sign In" />
            </form>
            <div className={cx('social-account-container')}>
                ...
                <div className={cx('social-accounts')}>
                    ...
                    <button className={cx('social-button', 'twitter')}>
                        <svg
                            className={cx('svg')}
                            xmlns="http://www.w3.org/2000/svg"
                            height="1em"
